...
website: [www.joseincio.com](www.joseincio.com)
...
Notes about R, and R features will be in boxes like this:

```{r eval=FALSE, class.source="Comment1"}
Example
```

Sometimes the output has warnings. We are not showing those here. In general, you shouldnt worry about warnings.However, be worry about errors. When the ouput shows "**error**" that means something is wrong and R didn't execute the code. 
